...
| PFAD         | Is an internal specification, from which path the property tree is to be used for the article data exchange. When importing into EULANDA the tree is saved relative to this specification. The default path is "\Shop" and should be specified for compatibility. | \Shop    | Text max: 8000 | (no)      |
