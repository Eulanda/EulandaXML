...
| PFAD         | Ist eine interne Angabe, ab welchem Pfad der Merkmalbaum für den Artikel-Datenaustausch benutzt werden soll. Beim Importieren in EULANDA wird der Baum relativ zu dieser Angabe gespeichert. Der Standardpfad ist "\Shop" und sollte aus Kompatibilität angegeben werden. | \Shop    | Text max: 32        | (nein) |
